...
Future<int> getMaxAvailableTimeSlot(DateTime dt) async {
  ...
  return 0;
    ...
    return 2;
  else if (syncTime.isAfter(DateTime(now.year, now.month, now.day, 10, 00)) &&
    ...
    return 3;
      ...
      syncTime.isBefore(DateTime(now.year, now.month, now.day, 11, 00)))
    return 4;
  else if (syncTime.isAfter(DateTime(now.year, now.month, now.day, 11, 00)) &&
    ...
    return 5;
      ...
      syncTime.isBefore(DateTime(now.year, now.month, now.day, 12, 00)))
    return 6;
  else if (syncTime.isAfter(DateTime(now.year, now.month, now.day, 12, 00)) &&
    ...
    return 7;
      ...
      syncTime.isBefore(DateTime(now.year, now.month, now.day, 13, 00)))
    return 8;
  else if (syncTime.isAfter(DateTime(now.year, now.month, now.day, 13, 00)) &&
    ...
    return 9;
      ...
      syncTime.isBefore(DateTime(now.year, now.month, now.day, 14, 00)))
    return 10;
  else if (syncTime.isAfter(DateTime(now.year, now.month, now.day, 14, 00)) &&
    ...
    return 11;
      ...
      syncTime.isBefore(DateTime(now.year, now.month, now.day, 15, 00)))
    return 12;
  else if (syncTime.isAfter(DateTime(now.year, now.month, now.day, 15, 00)) &&
    ...
    return 15;
      ...
      syncTime.isBefore(DateTime(now.year, now.month, now.day, 17, 00)))
    return 16;
  else if (syncTime.isAfter(DateTime(now.year, now.month, now.day, 17, 00)) &&
    ...
    return 17;
      ...
      syncTime.isBefore(DateTime(now.year, now.month, now.day, 18, 00)))
    return 18;
  else if (syncTime.isAfter(DateTime(now.year, now.month, now.day, 18, 00)) &&
